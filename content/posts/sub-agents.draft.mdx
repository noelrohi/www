...
## Method 1: Start with Claude Code docs

When I'm new to sub agents, I start with the examples in Claude Code's documentation. They're basic but give you a solid foundation to understand the structure. The docs show agents like code-reviewer, debugger, and data-scientist with clear system prompts and tool configurations.

These examples are general-purpose, but they teach you the fundamentals: how to write effective descriptions, which tools to grant, and how to structure system prompts. I use them as templates, then customize for my specific needs.

## Method 2: Search with grep.app
...
## Method 3: Use cursor.directory or similar
